console.log('[Passageiros Script] Carregando...');
...
console.log('[Passageiros Script] Variáveis inicializadas');
...
function addTrip(event) {
    ...
    const trip = {
        id: Date.now(),
        code: document.getElementById('pax-trip-code').value,
        origin: document.getElementById('pax-origin').value,
        destination: document.getElementById('pax-destination').value,
        date: document.getElementById('pax-trip-date').value,
        Cliente: document.getElementById('pax-client-name').value || 'Não informado',
        passengers: [],
        files: {
            flightBrief: [],
            contrato: [],
...
function openEditTripModal(event, tripId) {
    ...
    document.getElementById('pax-edit-trip-id').value = trip.id;
    document.getElementById('pax-edit-trip-code').value = trip.code;
    document.getElementById('pax-edit-origin').value = trip.origin;
    document.getElementById('pax-edit-destination').value = trip.destination;
    document.getElementById('pax-edit-trip-date').value = trip.date;
    document.getElementById('pax-edit-client-name').value = trip.Cliente || '';
...
function saveEditTrip(event) {
    ...
    const tripId = parseInt(document.getElementById('pax-edit-trip-id').value);
    const trip = trips.find(t => t.id === tripId);
    
    if (!trip) return;

    // Atualizar os dados da viagem
    trip.code = document.getElementById('pax-edit-trip-code').value;
    trip.origin = document.getElementById('pax-edit-origin').value;
    trip.destination = document.getElementById('pax-edit-destination').value;
    trip.date = document.getElementById('pax-edit-trip-date').value;
    trip.Cliente = document.getElementById('pax-edit-client-name').value;
...
function renderTrips() {
    console.log('[renderTrips] Chamada - Total de viagens:', trips.length);
    const grid = document.getElementById('trips-grid');
    const emptyState = document.getElementById('empty-state');
    
    console.log('[renderTrips] Grid element:', grid);
    console.log('[renderTrips] Empty state element:', emptyState);

    if (trips.length === 0) {
        if (grid) grid.style.display = 'none';
        if (emptyState) emptyState.style.display = 'block';
        console.log('[renderTrips] Mostrando empty state');
        return;
    }

    if (grid) grid.style.display = 'grid';
    if (emptyState) emptyState.style.display = 'none';
    console.log('[renderTrips] Renderizando', trips.length, 'viagens');
...
function setupPassengerAutocomplete() {
    const nameInput = document.getElementById('pax-passenger-name');
...
function fillPassengerForm(passenger) {
    document.getElementById('pax-passenger-name').value = passenger.name;
    document.getElementById('pax-passenger-passport').value = passenger.passport;
    document.getElementById('pax-passport-expiry').value = passenger.passportExpiry;
    document.getElementById('pax-birth-date').value = passenger.birthDate;
    document.getElementById('pax-passenger-gender').value = passenger.gender;
}
...
function addPassenger(event) {
    ...
    const passengerData = {
        name: document.getElementById('pax-passenger-name').value,
        passport: document.getElementById('pax-passenger-passport').value,
        passportExpiry: document.getElementById('pax-passport-expiry').value,
        birthDate: document.getElementById('pax-birth-date').value,
        gender: document.getElementById('pax-passenger-gender').value
    };
...
function openEditPassengerModal(passengerId) {
    ...
    document.getElementById('pax-edit-passenger-id').value = passenger.id;
    document.getElementById('pax-edit-passenger-name').value = passenger.name;
    document.getElementById('pax-edit-passenger-passport').value = passenger.passport;
    document.getElementById('pax-edit-passport-expiry').value = passenger.passportExpiry;
    document.getElementById('pax-edit-birth-date').value = passenger.birthDate;
    document.getElementById('pax-edit-passenger-gender').value = passenger.gender;
...
function saveEditPassenger(event) {
    ...
    const passengerId = parseInt(document.getElementById('pax-edit-passenger-id').value);
    const passenger = trip.passengers.find(p => p.id === passengerId);
    if (!passenger) return;
    
    // Atualizar dados do passageiro
    passenger.name = document.getElementById('pax-edit-passenger-name').value;
    passenger.passport = document.getElementById('pax-edit-passenger-passport').value;
    passenger.passportExpiry = document.getElementById('pax-edit-passport-expiry').value;
    passenger.birthDate = document.getElementById('pax-edit-birth-date').value;
    passenger.gender = document.getElementById('pax-edit-passenger-gender').value;
